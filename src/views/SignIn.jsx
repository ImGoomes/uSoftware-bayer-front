                ...
                <Col md="auto">
                    <div className="box width-signin">
                        ...
                        <form className="form">
                            ...
                            <input type="text" className="form-control mb-2" id="email" placeholder="e-mail" value={email} onChange={(e) => { setEmail(e.target.value) }} />

                            <label className="control-label">Password</label>
                            <input type="password" className="form-control mb-2" id="password" placeholder="password" value={password} onChange={(e) => { setPassword(e.target.value) }} />
                            <hr />
